...
const Archive = () => {
  ...
  const handleDeletePatient = async () => {
    ...
    try {
      const archive = archives.find((a) => a.original_id === deletePatient.id);
      ...
      if (data.success) {
        setPatients(prevPatients => {
          const updatedPatients = prevPatients.filter(patient => patient.id !== deletePatient.id);
          console.log("Updated patients after deletion:", updatedPatients);
          return updatedPatients;
        });
        
        setArchives(prevArchives => {
          const updatedArchives = prevArchives.filter(archive => archive.original_id !== deletePatient.id);
          console.log("Updated archives after deletion:", updatedArchives);
          return updatedArchives;
        });
        ...
        setMessageModal({
          isOpen: true,
          title: "Success",
          message: `Patient ${deletePatient.name} and related payments deleted successfully from archives.`,
          isError: false,
        });
      ...
      setMessageModal({
        isOpen: true,
        title: "Error",
        message: error.message || "An error occurred while deleting the patient.",
        isError: true,
      });
