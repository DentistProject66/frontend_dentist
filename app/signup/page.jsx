...
export default function SignUp() {
  ...
  const data = [
    { name: "email", id: 3, form_name: "email", type: "email", placeholder: "votre.email@exemple.com" },
    { name: "password", id: 4, form_name: "password", type: "password", placeholder: "••••••••" },
    { name: "phone", id: 5, form_name: "phone", type: "tel", placeholder: "+33 (0)6 00 00 00 00" },
    { name: "practice_name", id: 6, form_name: "practice_name", type: "text", placeholder: "Nom du cabinet" },
  ];
    ...
    >
      ...
      <div className="relative z-10 bg-white rounded-xl shadow-xl p-6 w-full max-w-md mx-4 my-8">
        ...
        <div className="text-center mb-4">
          ...
          <h1 className="text-lg font-semibold text-gray-800 mb-1">Créer votre compte</h1>
          <p className="text-gray-500 text-xs">Bienvenue ! Veuillez remplir vos informations.</p>
        </div>
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl p-6 max-w-sm w-full mx-4">
            <h2 className="text-lg font-semibold text-gray-800 mb-4">Inscription réussie !</h2>
            <p className="text-gray-600 text-sm mb-6">
              Veuillez attendre l’approbation de l’administrateur avant de vous connecter.
            </p>
            <button
              onClick={closeModalAndRedirect}
              className="w-full text-white font-medium py-2 px-4 rounded-md hover:opacity-90 text-sm"
