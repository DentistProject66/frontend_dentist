...
const AppointmentsPage = () => {
  ...
  useEffect(() => {
    const fetchDailyStats = async () => {
      ...
      try {
        ...
        const response = await fetch(`https://dental-backend-7opx.onrender.com/api/appointments/daily?date=${dateStr}`, {
          headers: { Authorization: `Bearer ${token}` },
        });
        const data = await response.json();
        if (response.ok && data.success) {
  ...
  const updateAppointment = async (appointmentId, updateData) => {
    try {
      ...
      const response = await fetch(`https://dental-backend-7opx.onrender.com/api/appointments/${appointmentId}`, {
        method: 'PUT',
        headers: {
  ...
  const cancelAppointment = async (appointmentId) => {
    try {
      setActionLoading(true);
      const response = await fetch(`https://dental-backend-7opx.onrender.com/api/appointments/cancel/${appointmentId}`, {
        method: 'POST',
        headers: { Authorization: `Bearer ${token}` }
      });
      const data = await response.json();
  ...
  const completeAppointment = async (appointmentId) => {
    try {
      setActionLoading(true);
      const response = await fetch(`https://dental-backend-7opx.onrender.com/api/appointments/complete/${appointmentId}`, {
        method: 'POST',
        headers: { Authorization: `Bearer ${token}` }
      });
      const data = await response.json();
  ...
  const createAppointment = async (appointmentData) => {
    try {
      setActionLoading(true);
      const response = await fetch('https://dental-backend-7opx.onrender.com/api/consultations', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
      ...
      if (response.ok && data.success) {
        ...
        const appointmentsResponse = await fetch('https://dental-backend-7opx.onrender.com/api/appointments', {
          headers: { Authorization: `Bearer ${token}` },
        });
  ...
  const fetchAvailableSlots = async (date) => {
    try {
      ...
      const response = await fetch(`https://dental-backend-7opx.onrender.com/api/appointments/slots/${dateStr}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
      const data = await response.json();
      if (response.ok && data.success) {
